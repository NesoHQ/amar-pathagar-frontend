  ...
  return (
    <div className="space-y-4">
      {requestList.map((req: any) => (
        <div key={req.id} className="border-2 border-old-border p-4 hover:border-old-ink transition-all bg-gradient-to-r from-white to-gray-50">
          <div className="flex flex-col gap-4">
            ...
            {/* Action Buttons */}
            <div className="flex flex-col sm:flex-row gap-2 pt-2 border-t-2 border-old-border">
              <button
